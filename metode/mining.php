...
function mining_process($db_object, $min_support, $min_confidence, $start_date, $end_date, $id_process){
    ...
    echo "<table class='table table-bordered table-striped  table-hover'>
            <tr style='background-color: #131368;'>
                ...
                <th style='color:white;'>Suppport</th>
    ...
    echo "<table class='table table-bordered table-striped  table-hover'>
            <tr style='background-color: #131368;'>
                <th style='color:white;'>No</th>
                <th style='color:white;'>Item1</th>
                <th style='color:white;'>Item2</th>
                <th style='color:white;'>Jumlah</th>
                <th style='color:white;'>Suppport</th>
                <th style='color:white;'>Keterangan</th>
            </tr>";
    ...
    echo "<table class='table table-bordered table-striped  table-hover'>
            <tr style='background-color: #131368;'>
                <th style='color:white;'>No</th>
                <th style='color:white;'>Item 1</th>
                <th style='color:white;'>Item 2</th>
                <th style='color:white;'>Jumlah</th>
                <th style='color:white;'>Suppport</th>
            </tr>";
    $no=1;
    ...
    echo "<table class='table table-bordered table-striped  table-hover'>
            <tr style='background-color: #131368;'>
                ...
                <th style='color:white;'>Item 1</th>
                <th style='color:white;'>Item 2</th>
                <th style='color:white;'>Item 3</th>
                <th style='color:white;'>Jumlah</th>
                <th style='color:white;'>Suppport</th>
            </tr>";
    $no=1;
