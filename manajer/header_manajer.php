      ...
      <div class="collapse navbar-collapse">
        <ul class="navbar-nav ml-auto">
          <li class="<?php echo $menu; ?>" style="margin-top: 10px; width: 126px;">
           <a href="index.php?akses=manajer&kl=m1" class="nav-link">
            <center>
        ...
        <li class="<?php echo $menu3; ?>" style="margin-top: 10px; width: 190px;">
         <a href="index.php?akses=manajer&kl=m3" class="nav-link">
          <center>
            <span class="glyphicon glyphicon-plus" style="color: white;"></span>
            <font size="4"><b>Lihat Transaksi</b></font>
          </center>
        </a>
      </li>
      <span style="color :white; margin-top: 25px; font-size: 16px;"><b>|</b></span>
      <li class="<?php echo $menu2; ?>" style="margin-top: 10px; width: 170px;">
       <a href="index.php?akses=manajer&kl=m2" class="nav-link">
        <center>
          <span class="glyphicon glyphicon-paste" style="color: white;"></span>
          <font size="4"><b>Proses Apriori</b></font>
        </center>
      </a>
    </li>
    <span style="color :white; margin-top: 25px; font-size: 16px;"><b>|</b></span>
